...
# Error 1: 'os.environ.get' do baar tha, ab theek hai.
CHANNEL_OR_GROUP = os.environ.get("CHANNEL_OR_GROUP", "@Junaidniz786")
...
# Admin panel key
# Error 2: 'os.environ.get' do baar tha, ab theek hai.
ADMIN_KEY = os.environ.get("ADMIN_KEY", "Junaid123@")
